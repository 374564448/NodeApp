package com.banmingi.nodeapp.contentcenter.util;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 会生成类似该字符串的内容: eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODc1NDk0NTYsImV4cCI6MTU4ODc1OTA1Nn0.TtWekq4kThTS3toPp7yNcT1HOFKC91VCytznPdYWjxk
        System.out.println(token);

        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODc1NDk0NTYsImV4cCI6MTU4ODc1OTA1Nn0.TtWekq4kThTS3toPp7yNcT1HOFKC91VCytznPdYWjxk";
